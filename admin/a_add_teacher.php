...
<body>
    ...
    <div class="header">
        ...
        <div class="header-right dropdown myac">
            ...
            <br>
<form class="was-validated bg-light border shadow p-3" action="a_add_teacher.php" method="POST" enctype="multipart/form-data" name="form">
...
<?php
    ...
    if(isset($_POST['Submit'])){
        ...
        if($teacher_password == $confirm_teacher_password){
            ...
            $query = "INSERT INTO teachers (teacher_fullname,  teacher_email, teacher_phone, teacher_password)
                                VALUES ('$teacher_fullname', '$teacher_email', '$teacher_phone', '$teacher_password')";

            if(mysqli_query($con, $query)){
                $msg = "You have Successfully Add a Teacher!";
                echo $msg;
            }
    ...
    <br>
        <div class="row mt-3">
            ...
            <div class="form-group mt-2 col-md-6 col-sm-12">
                ...
                <input type="text" class="form-control" name="teacher_fullname" id="email" placeholder="Enter Full Name" required>
        ...
        <div class="row mt-3">
            ...
            <div class="form-group mt-2 col-md-6 col-sm-12">
                ...
                <input type="text" class="form-control" name="teacher_email" id="email" placeholder="Enter Email"  required>
                        <div class="valid-feedback">good</div>
            </div>
        </div>
        ...
        <div class="row mt-3">
            ...
            <div class="form-group mt-2 col-md-6 col-sm-12">
                ...
                <input type="phone" class="form-control" name="teacher_phone" id="email" placeholder="Enter Phone Number" required>
                        <div class="valid-feedback">good</div>
            </div>
        </div>
...
<div class="row">
    <div class="col-md mt-3 mb-3">
        <button type="submit" name="Submit" class="btn btn-primary btn-large col-md-12" value="Submit">Add Teacher</button>
    </div> 
</div>    
