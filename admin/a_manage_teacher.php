...
<body>
    ...
    <a href="a_add_teacher.php" ><button> Add New Teacher </button></a>
                                  ...
                                  <tbody>
                                    ...
                                    // Commented Section
                                        ...
                                        while($row = mysqli_fetch_assoc($q_result)){
                                            ...
                                            $row['teacher_id'],
                                            htmlspecialchars($row['teacher_fullname']),
                                            htmlspecialchars($row['teacher_email']),
                                            htmlspecialchars($row['teacher_phone']),
                                             );
                                    ?>
                                    <td class="text-center h4">
                                    <a href="a_edit_teacher.php?id=<?php echo $row['teacher_id'] ?>"><i>Edit</i></a>
                                        <br>
                                        <a href="a_delete_teacher.php?id=<?php echo $row['teacher_id'] ?>"><i>Delete</i></a>
                                    </td>
