...
<?php
    ...
    if(isset($_POST['Submit'])){
        ...
        if($student_password == $confirm_student_password){
            ...
            $query = "INSERT INTO students (full_name,  mother_name, address, phone, age, student_email, student_password)
                                VALUES ('$student_fullname', '$mother_name', '$student_address', '$student_phone', '$student_age', '$student_email', '$student_password')";
    ...
    <br>
        <div class="row mt-3">
            ...
            <div class="form-group mt-2 col-md-6 col-sm-12">
                ...
                <input type="text" class="form-control" name="student_fullname" id="email" placeholder="Enter Full Name" required>
        ...
        <div class="row mt-3">
            ...
            <div class="form-group mt-2 col-md-6 col-sm-12">
                ...
                <input type="text" class="form-control" name="mother_name" id="email" placeholder="Enter Mother Name" required>
                        <div class="valid-feedback">good</div>
            </div>
        </div>
        ...
        <div class="row mt-3">
            ...
            <div class="form-group mt-2 col-md-6 col-sm-12">
                ...
                <input type="text" class="form-control" name="student_address" id="email" placeholder="Enter Address"  required>
                        <div class="valid-feedback">good</div>
            </div>
        </div>
        ...
        <div class="row mt-3">
            ...
            <div class="form-group mt-2 col-md-6 col-sm-12">
                ...
                <input type="phone" class="form-control" name="student_phone" id="email" placeholder="Enter Phone Number" required>
                        <div class="valid-feedback">good</div>
            </div>
        </div>
        ...
        <div class="row mt-3">
            ...
            <div class="form-group mt-2 col-md-6 col-sm-12">
                ...
                <input type="text" class="form-control" name="student_age" id="email" placeholder="Enter Age"  required>
                        <div class="valid-feedback">good</div>
            </div>
        </div>
        ...
        <div class="row mt-3">
            ...
            <div class="form-group mt-2 col-md-6 col-sm-12">
                ...
                <input type="email" class="form-control" name="student_email" id="email" placeholder="Enter Email Address" required>
                        <div class="valid-feedback">good</div>
            </div>
        </div>
