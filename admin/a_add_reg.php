...
<body>
    ...
    <div class="header">
        ...
        <div class="header-right dropdown myac">
            ...
            <br>
<form class="was-validated bg-light border shadow p-3" action="a_add_reg.php" method="POST" enctype="multipart/form-data" name="form">
...
<?php
    ...
    if(isset($_POST['Submit'])){
        ...
        if($registral_password == $confirm_registral_password){
            ...
            $query = "INSERT INTO registral (registral_fullname,  registral_email, registral_phone, registral_password)
                                VALUES ('$registral_fullname', '$registral_email', '$registral_phone', '$registral_password')";

            if(mysqli_query($con, $query)){
                $msg = "You have Successfully Add a registral!";
                echo $msg;
            }
    ...
    <br>
        <div class="row mt-3">
            ...
            <div class="form-group mt-2 col-md-6 col-sm-12">
                ...
                <input type="text" class="form-control" name="registral_fullname" id="email" placeholder="Enter Full Name" required>
        ...
        <div class="row mt-3">
            ...
            <div class="form-group mt-2 col-md-6 col-sm-12">
                ...
                <input type="text" class="form-control" name="registral_email" id="email" placeholder="Enter Email"  required>
                        <div class="valid-feedback">good</div>
            </div>
        </div>
        ...
        <div class="row mt-3">
            ...
            <div class="form-group mt-2 col-md-6 col-sm-12">
                ...
                <input type="phone" class="form-control" name="registral_phone" id="email" placeholder="Enter Phone Number" required>
                        <div class="valid-feedback">good</div>
            </div>
        </div>
