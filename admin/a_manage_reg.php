...
<body>
    ...
    <a href="a_add_reg.php" ><button> Add New Registral </button></a>
                        ...
                        <div class="row">
                            <div class="col-md">
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr class="h5">
                                            <th colspan="9" class="bg-dark text-white"><center>Registral Table</center></th>
                                        </tr>
                                    </thead>
                                  <thead>
                                  ...
                                  <tbody>
                                    ...
                                    // Commented Section
                                        ...
                                        $q = "SELECT * FROM registral";
                                        $q_result = mysqli_query($con,$q);
                                        while($row = mysqli_fetch_assoc($q_result)){
                                            printf("<tr> <td>%d</td> <td>%s</td> <td>%s</td> <td>%s</td>  ",
                                            $row['registral_id'],
                                            htmlspecialchars($row['registral_fullname']),
                                            htmlspecialchars($row['registral_email']),
                                            htmlspecialchars($row['registral_phone']),
                                             );
                                    ?>
                                    <td class="text-center h4">
                                    <a href="a_edit_reg.php?id=<?php echo $row['registral_id'] ?>"><i>Edit</i></a>
                                        <br>
                                        <a href="a_delete_reg.php?id=<?php echo $row['registral_id'] ?>"><i>Delete</i></a>
                                    </td>
