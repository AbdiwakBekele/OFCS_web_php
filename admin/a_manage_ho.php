...
<body>
    ...
    <a href="a_add_ho.php" ><button> Add New Health Officer </button></a>
                        ...
                        <div class="row">
                            <div class="col-md">
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr class="h5">
                                            <th colspan="9" class="bg-dark text-white"><center>Health Officers Table</center></th>
                                        </tr>
                                    </thead>
                                  <thead>
                                  ...
                                  <tbody>
                                    ...
                                    // Commented Section
                                        ...
                                        while($row = mysqli_fetch_assoc($q_result)){
                                            ...
                                            $row['ho_id'],
                                            htmlspecialchars($row['ho_fullname']),
                                            htmlspecialchars($row['ho_email']),
                                            htmlspecialchars($row['ho_phone']),
                                             );
                                    ?>
                                    <td class="text-center h4">
                                    <a href="a_edit_ho.php?id=<?php echo $row['ho_id'] ?>"><i>Edit</i></a>
                                        <br>
                                        <a href="a_delete_ho.php?id=<?php echo $row['ho_id'] ?>"><i>Delete</i></a>
                                    </td>
