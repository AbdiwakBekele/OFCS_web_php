...
$result_id = $_POST['result_id'];
 ...
 $query = "UPDATE result SET result = '$result' WHERE result_id = '$result_id' ";

 if(mysqli_query($con, $query)){
     $msg = "You have Successfully edit student result!";
     echo $msg;
 }
...
if(isset($_REQUEST['id'])){
    $result_id = intval($_REQUEST['id']);

    $array = array();
    $course_name = "";
     $q = "SELECT * FROM result WHERE result_id = '$result_id'";
   ...
   while ($r = mysqli_fetch_assoc($q_result )){
     ...
     while ($row = mysqli_fetch_assoc($q_course_result)){
...
<form class="was-validated bg-light border shadow p-3" action="a_give_grade.php" method="POST" enctype="multipart/form-data" name="form">

<!-- Grade Input-->
<div class="row mt-3">
 <div class="form-group col-md-12">
    
     <label for="fullname" class="form-label"><h6><b><i class="fas fa-user"></i> <?php echo $course_name; ?></b></h6></label>
     <input type="number" class="form-control" name="result" id="fullname" placeholder="Enter Result" value=" <?php echo $array['result']; ?>" required>
