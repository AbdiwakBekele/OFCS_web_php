...
// Database Update PHP Code 
    ...
    if(isset($_POST['Submit'])){
        ...
        if($teacher_password == $confirm_teacher_password){
            ...
            $query = "UPDATE teachers SET teacher_fullname = '$teacher_fullname',  teacher_phone = '$teacher_phone',  teacher_email = '$teacher_email', teacher_password = '$teacher_password' WHERE teacher_id = '$teacher_id' ";
  ...
  //////// Request from Manage teacher Page //////
    ...
    if(isset($_REQUEST['id'])){
        ...
        $array = array();
                $q = "SELECT * FROM teachers WHERE teacher_id = '$teacher_id'";
                $q_result = mysqli_query($con,$q);
       
              while ($r = mysqli_fetch_assoc($q_result )){
                $array['teacher_fullname'] = $r['teacher_fullname'];
                $array['teacher_phone'] = $r['teacher_phone'];
                $array['teacher_email'] = $r['teacher_email'];
               }
?>           

<form class="was-validated bg-light border shadow p-3" action="a_edit_teacher.php" method="POST" enctype="multipart/form-data" name="form">
        ...
        <div class="row mt-3">
            ...
            <div class="form-group mt-2 col-md-6 col-sm-12">
                ...
                <input type="text" class="form-control" name="teacher_fullname" id="email" placeholder="Enter Full Name" value=" <?php echo $array['teacher_fullname']; ?>" required>
        ...
        <div class="row mt-3">
            ...
            <div class="form-group mt-2 col-md-6 col-sm-12">
                ...
                <input type="phone" class="form-control" name="teacher_phone" id="email" placeholder="Enter Phone Number" value=" <?php echo $array['teacher_phone']; ?>" required>
                        <div class="valid-feedback">good</div>
            </div>
        </div>
        ...
        <div class="row mt-3">
            ...
            <div class="form-group mt-2 col-md-6 col-sm-12">
                ...
                <input type="email" class="form-control" name="teacher_email" id="email" placeholder="Enter Email Address" value=" <?php echo $array['teacher_email']; ?>" required>
                        <div class="valid-feedback">good</div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md mt-3 mb-3">
            ...
            <button type="submit" name="Submit" class="btn btn-primary btn-large col-md-12" value="Submit">Edit Teacher</button>
        </div> 
    </div>   
    </form>
<?php
