...
// Database Update PHP Code 
    ...
    if(isset($_POST['Submit'])){
        ...
        $confirm_parent_password =  md5($_POST['confirm_parent_password']);
        
        if($parent_password == $confirm_parent_password){
            
           

            $query = "UPDATE parent SET parent_fullname = '$parent_fullname',  parent_phone = '$parent_phone',  parent_email = '$parent_email', parent_password = '$parent_password' WHERE parent_id = '$parent_id' ";

            if(mysqli_query($con, $query)){
                echo "<br> <br>";
                $msg = "You have Successfully Updated a parent information!";
                echo $msg;
            }
  ...
  //////// Request from Manage parent Page //////
    ...
    if(isset($_REQUEST['id'])){
        ...
        $array = array();
              ...
              while ($r = mysqli_fetch_assoc($q_result )){
                $array['parent_fullname'] = $r['parent_fullname'];
                $array['parent_phone'] = $r['parent_phone'];
                $array['parent_email'] = $r['parent_email'];
               }
?>           

<form class="was-validated bg-light border shadow p-3" action="a_edit_parent.php" method="POST" enctype="multipart/form-data" name="form">
        ...
        <div class="row mt-3">
            ...
            <div class="form-group mt-2 col-md-6 col-sm-12">
                ...
                <input type="text" class="form-control" name="parent_fullname" id="email" placeholder="Enter Full Name" value=" <?php echo $array['parent_fullname']; ?>" required>
        ...
        <div class="row mt-3">
            ...
            <div class="form-group mt-2 col-md-6 col-sm-12">
                ...
                <input type="phone" class="form-control" name="parent_phone" id="email" placeholder="Enter Phone Number" value=" <?php echo $array['parent_phone']; ?>" required>
                        <div class="valid-feedback">good</div>
            </div>
        </div>
        ...
        <div class="row mt-3">
            ...
            <div class="form-group mt-2 col-md-6 col-sm-12">
                ...
                <input type="email" class="form-control" name="parent_email" id="email" placeholder="Enter Email Address" value=" <?php echo $array['parent_email']; ?>" required>
                        <div class="valid-feedback">good</div>
            </div>
        </div>
        ...
        <div class="row mt-3">
            ...
            <div class="form-group mt-2 col-md-6 col-sm-12">
                ...
                <input type="password" class="form-control" name="parent_password" id="email" placeholder="Enter Password" required>
                        <div class="valid-feedback">good</div> 
            </div>
            ...
            <div class="form-group col-md-6 col-sm-12">
                ...
                <input type="password" class="form-control" name="confirm_parent_password" for="mob_no" placeholder="Confirm Your Password" maxlength="10" required>
