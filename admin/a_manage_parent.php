...
<body>
    ...
    <a href="a_add_parent.php" ><button> Add New Parent </button></a>
                        ...
                        <div class="row">
                            <div class="col-md">
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr class="h5">
                                            <th colspan="9" class="bg-dark text-white"><center>parent Table</center></th>
                                        </tr>
                                    </thead>
                                  <thead>
                                  ...
                                  <tbody>
                                    ...
                                    // Commented Section
                                        ...
                                        while($row = mysqli_fetch_assoc($q_result)){
                                            ...
                                            $row['parent_id'],
                                            htmlspecialchars($row['parent_fullname']),
                                            htmlspecialchars($row['parent_email']),
                                            htmlspecialchars($row['parent_phone']),
                                             );
                                    ?>
                                    <td class="text-center h4">
                                    <a href="a_edit_parent.php?id=<?php echo $row['parent_id'] ?>"><i>Edit</i></a>
                                        <br>
                                        <a href="a_delete_parent.php?id=<?php echo $row['parent_id'] ?>"><i>Delete</i></a>
                                    </td>
