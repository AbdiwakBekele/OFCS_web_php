                        ...
                        <div class="row">
                            <div class="col-md">
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr class="h5">
                                            <th colspan="9" class="bg-dark text-white"><center>Student Health and Discipline Status</center></th>
                                        </tr>
                                    </thead>

                                    <thead>
                                        <tr class="h5 bg-primary text-white">
                                            <th class="text-center" scope="col">Health Status</th>
                                            <th class="text-center" scope="col">Discipline Status</th>
                                        </tr>
                                    </thead>
