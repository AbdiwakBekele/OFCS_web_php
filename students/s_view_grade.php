                        ...
                        <div class="row">
                            <div class="col-md">
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr class="h5">
                                            <th colspan="9" class="bg-dark text-white"><center>Result Table</center></th>
                                        </tr>
                                    </thead>
                                    ...
                                    <thead>
                                        <tr class="h5 bg-primary text-white">
                                            ...
                                            <th class="text-center" scope="col">Biology</th>
                                            <th class="text-center" scope="col">Chemistry</th>
