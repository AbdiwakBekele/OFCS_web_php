    ...
    <center>
            ...
            <?php
                ...
                if(isset($_POST['Submit'])){
                    ...
                    $comment = $_POST['comment'];
                        ...
                        $query = "INSERT INTO comment (comments)
                                            VALUES ('$comment')";

                        if(mysqli_query($con, $query)){
                            $msg = "You have Successfully Give a Comment!";
                            echo $msg;
                        }
            ...
            ?>
                ...
                <div class="row mt-3">
                    <div class="form-group col-md-12">
                        <label for="sh_descrip"><h6><b><i class="fas fa-book-open"></i> Your Comment </b></h6></label>
                        <textarea type="text" class="form-control" name="comment" id="sh_descrip" rows="4" maxlength="400" placeholder="Enter your comment." required></textarea>
            ...
            <div class="row">
                <div class="col-md mt-3 mb-3">
                    <button type="submit" name="Submit" class="btn btn-primary btn-large col-md-12" value="Submit">Give Comment</button>
                </div> 
            </div>    
