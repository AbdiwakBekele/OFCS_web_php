...
<body>
    ...
    if(isset($_REQUEST['id'])){
        ...
        $q = "SELECT * FROM payment WHERE student_id = '$student_id'";
        $q_result = mysqli_query($con,$q);
        while($row = mysqli_fetch_assoc($q_result)){

            $receipt_photo = $row['payment_photo'];
            $month = $row['month'];


            echo "<h4>Month: $month </h4><br>";
            echo "<img src='../students/payments/$receipt_photo' width = '400px' height='400px' >";
            echo "<hr>";
