                        ...
                        <div class="row">
                            <div class="col-md">
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr class="h5">
                                            <th colspan="9" class="bg-dark text-white"><center>Students List</center></th>
                                        </tr>
                                    </thead>
                                  <thead>
                                  ...
                                  <tbody>
                                    ...
                                    <td class="text-center h4">
                                        <a href="f_receipts.php?id=<?php echo $row['student_id'] ?>"><i>View</i></a>
                                    </td>
